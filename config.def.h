...
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray2, "-sf", col_gray4, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_h,      focusdir,       {.i = -1 } },
	{ MODKEY|ControlMask,           XK_l,      focusdir,       {.i = +1 } },
	{ MODKEY|Mod1Mask,              XK_h,      tagfollowmon,   {.i = -1 } },
